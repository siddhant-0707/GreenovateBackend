"""
Django settings for greenovate_backend project.
...
SECRET_KEY = 'django-insecure-$vhw^a@cxi!2c$@ql&+p!ft^fisy3%0$+j8+u*&pxh3143(6w-'
...
ROOT_URLCONF = 'greenovate_backend.urls'
...
WSGI_APPLICATION = 'greenovate_backend.wsgi.application'
